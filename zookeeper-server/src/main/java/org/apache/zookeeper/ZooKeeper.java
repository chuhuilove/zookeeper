...
public class ZooKeeper implements AutoCloseable {
    ...
    /**
     * 要创建ZooKeeper客户端对象,
     * 应用程序需要传递一个包含以逗号分隔的host:port对列表的连接字符串,
     * 每个对对应于ZooKeeper服务器.
     * <p>
    ...
    /**
     * 对{@code RequestHeader}设置创建模式
     *
     * @param createMode 节点的模式
     * @param h
     */
    ...
    /**
     * 将提供的参数封装成一个{@code Record}对象.
     *
     * @param createMode 节点模式
     * @param serverPath 节点存放的服务端路径
     * @param data       节点中的数据
     * @param acl        访问控制权限
     * @param ttl        时间吧..
     * @return
