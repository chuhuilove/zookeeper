...
public class QuorumPeer extends ZooKeeperThread implements QuorumStats.Provider {
    ...
    public void setElectionType(int electionType) {
        ...
        // 设置选举算法的调用链
//       stack:java.lang.Thread.getStackTrace(Thread.java:1559)
//       stack:org.apache.zookeeper.ZKUtil.logStackInfo(ZKUtil.java:174)
//       stack:org.apache.zookeeper.server.quorum.QuorumPeer.setElectionType(QuorumPeer.java:1800)
//       stack:org.apache.zookeeper.server.quorum.QuorumPeerMain.runFromConfig(QuorumPeerMain.java:196)
//       stack:org.apache.zookeeper.server.quorum.QuorumPeerMain.initializeAndRun(QuorumPeerMain.java:137)
//       stack:org.apache.zookeeper.server.quorum.QuorumPeerMain.main(QuorumPeerMain.java:94)
     ...
     *
     * 更新领导者选举信息,以避免在新服务器尝试加入集合时出现不一致.
     * <p>
