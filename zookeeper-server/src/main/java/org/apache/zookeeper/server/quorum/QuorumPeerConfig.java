...
public class QuorumPeerConfig {
    ...
    public void parse(String path) throws ConfigException {
        ...
        try {
            ...
            try {
                // 配置文件已经变成FileInputStream类型了,然后将其加载进一个Properties内
                cfg.load(in);
                configFileStr = path;
            } finally {
                in.close();
    ...
    public void parseProperties(Properties zkProp)
        ...
        for (Entry<Object, Object> entry : zkProp.entrySet()) {
            ...
            if (key.equals(DATA_DIR)) {
                ...
                /**
                 * 将一些属性,加上前缀zookeeper.,存储到系统环境中
                 */
                LOG.info("{} add prefix 'zookeeper.',and put into System.setProperty,the value is {}.", key, value);
        ...
        /**
         * session的最大最小超时间,如果没显式设置,就和{@link tickTime}有关
         *
         * 设想一种场景:将{@link tickTime}设置为负值,然后将{@link minSessionTimeout}和{@link maxSessionTimeout}
         * 都设置上值,且{@link minSessionTimeout}小于{@link maxSessionTimeout}
         * 那么岂不是直接绕过{@link tickTime}了吗?
         * 这算不算是一个bug呢?
         * 而现在的主要目的,就是整明白{@link tickTime}到底是干嘛用的?
         *
         */
        ...
        LOG.info("minSessionTimeout:" + minSessionTimeout + " maxSessionTimeout:" + maxSessionTimeout + " tickTime:" + tickTime);
